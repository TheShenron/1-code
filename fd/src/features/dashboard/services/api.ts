...
import { getTasksResponseSchema, GetTasksResponse, TicketStatus, CreateTicket, UpdateTicket, CreateTasksResponse } from '../schema/tickect.schema';
...
export const updateTicket = async(id: string, payload: UpdateTicket): Promise<CreateTasksResponse> => {
...
export const updateTicketStatus = async(id: string, newState: TicketStatus): Promise<CreateTasksResponse> => {
